...
def main(
    ...
    batch_size = 64,
    max_tokens = 64,
    distribution_file_path: str = "/hdd/hjl8708/VIM/source/data/extreme_distributions.csv",
    result_path: str = "/hdd/hjl8708/VIM/source/results",
    value_dsitribution_name: str = 'Ach',
    ...
    # Prepare the prompt (from value Distribution)
